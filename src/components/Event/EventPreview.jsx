...
import { Button } from "../ui/button";
import { usePdfGenerator } from "../hookPDF"; // Import your PDF hook
      ...
      <div className="max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl rounded-2xl border border-gray-700">
        <div className="relative bg-gradient-to-br from-gray-900 to-gray-800">
          ...
          <div className="p-6">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-end">
              {isPastEvent ? (
                // Past Event: Download PDF (using PDF generation)
                <Button
                  onClick={handleDownloadPDF}
                  className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold py-3 px-6 rounded-lg flex items-center gap-2 transition-all"
                >
